        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between mt-5'>
          <div className='flex mb-3 md:mb-0'>
            <div className='flex gap-3 flex-col items-center justify-center mr-4'>
              <p className='text-xs md:font-bold lg:text-xl text-center'>Start From</p>
              <p className='md:font-bold flex font-medium text-lg xl:text-5xl'>
                ${featuredRoom.price}
              </p>
            </div>
            <div className='flex gap-3 flex-col items-center justify-center mr-4 ml-3'>
              <p className='text-xs md:font-bold lg:text-xl text-center ml-4'>Save Upto</p>
              <p className='md:font-bold flex font-medium text-lg xl:text-5xl ml-5'>
